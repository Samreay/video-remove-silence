...
parser.add_argument('--constant', type=float, default=0.1, help='duration constant transform value')
parser.add_argument('--sublinear', type=float, default=0.3, help='duration sublinear transform factor')
parser.add_argument('--linear', type=float, default=0.08, help='duration linear transform factor')
